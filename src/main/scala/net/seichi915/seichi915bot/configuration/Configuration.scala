package net.seichi915.seichi915bot.configuration
...
object Configuration {
  ...
  def getRoleBotChannelId: Long =
    getLong("ChannelId", "RoleBotChannel").getOrElse(0)

  def getMemberRoleId: Long = getLong("RoleId", "MemberRole").getOrElse(0)
